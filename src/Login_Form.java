...
public class Login_Form extends JFrame {
    ...
    public Login_Form() {
        ...
        // Load window icon safely
        URL loginURL = Login_Form.class.getResource("/image/login.png");
        if (loginURL != null) {
            setIconImage(new ImageIcon(loginURL).getImage());
        } else {
            System.err.println("ERROR: /image/login.png not found in resources!");
        }
        ...
        // Load admin icon safely
        URL adminIconURL = Login_Form.class.getResource("/image/icons8-admin-96.png");
        JLabel iconLabel;
        if (adminIconURL != null) {
            iconLabel = new JLabel(new ImageIcon(adminIconURL), SwingConstants.CENTER);
        } else {
            System.err.println("ERROR: /image/icons_admin-96.png not found in resources!");
            iconLabel = new JLabel("Icon Missing", SwingConstants.CENTER);
        }
